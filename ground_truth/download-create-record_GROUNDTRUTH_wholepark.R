...
park <- "Gonarezhou"  # This is the folder name inside the working directory with all the files for the park
landsat.image <- "gonarezhou_backdrop_mosaic.tif"  # this needs to be a landsat image that covers the entire sample area. It serves as a template for point creation
...
park.boundary <- park # this is the simple outline of the park
